...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 28 16:55:56 2025
...
#                                          Training Set
# --------------------------------------------------------------------------------------------------- 
X = np.load('/Users/lzxvc/Downloads/OneDrive_1_1-28-2025/qRW_X_100000000.npy')
Y = np.load('/Users/lzxvc/Downloads/OneDrive_1_1-28-2025/qRW_Y_100000000.npy')
...
#                                        Validation Set
# --------------------------------------------------------------------------------------------------- 
X_new = np.load('/Users/lzxvc/Downloads/OneDrive_1_1-28-2025/qRW_X_val_1000000.npy')
Y_new = np.load('/Users/lzxvc/Downloads/OneDrive_1_1-28-2025/qRW_Y_val_1000000.npy')
X_new = X_new.astype(np.float32)
Y_new_log = np.log(Y_new).astype(np.float32)
...
train_loader = DataLoader(
    ...
    shuffle=True,
    num_workers=4,       # Increase if CPU cores are available
...
class MLP(nn.Module):
    def __init__(self, input_dim=4, hidden_dim=512, output_dim=1, num_layers=4):
...
with torch.no_grad():
    y_sub_pred = model(X_new_sub_torch.to(device))
